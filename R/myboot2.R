...
#' @param alpha (1-alpha)*100 percent confidence interval
#' @param cx character expansion factor for text in histogram
#' @param ... extra parameters for histogram if want to use
#' @importFrom graphics segments text
#' @importFrom stats quantile
#'
#' @return histogram of bootstrap confidence interval and list with important variables
#' @export
#'
#' @examples
